    ...
    <div class="card">
        <div class="card-body" style="background-color: rgba(7,94,132,0.05);">
            ...
            <div class="alert alert-danger text-center" role="alert">
                ...
                <p><b>By pressing the delete button, you will delete the following task:</b></p>
                <hr>
                <?php $delete->SelectedForDelete(); ?>
                <hr>
                <button class="btn btn-danger text-center border rounded shadow" name="delete" type="submit" style="margin: 11px;">Delete</button>
                <a href="firstpage.php" class="btn btn-dark text-center border rounded shadow " style="margin: 11px;">Cancel</a>
            </div>
